...
public class Bookinggeneric {
    ...
    @OneToMany(mappedBy = "bookinggeneric", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
    private Set<Bookinggenericpax> bookinggenericpaxes = new LinkedHashSet<>();
